                    ...
                    collection.find({}, {
                        ...
                        for(var k =0;k<cluster.length;k++){
                            for(var j=0;j<rekomendasi.length;j++){
                                nilai = Math.sqrt((parseInt(rekomendasi[j].action - parseInt(cluster[k].action)) ^ 2)
                                + (parseInt(rekomendasi[j].adventure - parseInt(cluster[k].adventure)) ^ 2)
                                + (parseInt(rekomendasi[j].comedy - parseInt(cluster[k].comedy)) ^ 2)
                                + (parseInt(rekomendasi[j].scifi - parseInt(cluster[k].scifi)) ^ 2)
                                + (parseInt(rekomendasi[j].drama - parseInt(cluster[k].drama)) ^ 2)
                                + (parseInt(rekomendasi[j].space - parseInt(cluster[k].space))
                                + (parseInt(rekomendasi[j].supernatural - parseInt(cluster[k].supernatural)) ^ 2)
                                + (parseInt(rekomendasi[j].thriller - parseInt(cluster[k].thriller)) ^ 2)
                                + (parseInt(rekomendasi[j].mystery - parseInt(cluster[k].mystery)) ^ 2)
                                + (parseInt(rekomendasi[j].seinen - parseInt(cluster[k].seinen)) ^ 2)
                                + (parseInt(rekomendasi[j].school - parseInt(cluster[k].school)) ^ 2)
                                + (parseInt(rekomendasi[j].historical - parseInt(cluster[k].historical)) ^ 2)
                                + (parseInt(rekomendasi[j].echi - parseInt(cluster[k].echi)) ^ 2)
                                + (parseInt(rekomendasi[j].sliceoflife - parseInt(cluster[k].sliceoflife)) ^ 2)
                                + (parseInt(rekomendasi[j].harem - parseInt(cluster[k].harem)) ^ 2)
                                + (parseInt(rekomendasi[j].pyschological - parseInt(cluster[k].pyschological)) ^ 2)
                                + (parseInt(rekomendasi[j].superpower - parseInt(cluster[k].superpower)) ^ 2)
                                + (parseInt(rekomendasi[j].fantasy - parseInt(cluster[k].fantasy)) ^ 2)
                                + (parseInt(rekomendasi[j].mecha - parseInt(cluster[k].mecha)) ^ 2)
                                + (parseInt(rekomendasi[j].sports - parseInt(cluster[k].sports)) ^ 2)
                                + (parseInt(rekomendasi[j].romance - parseInt(cluster[k].romance)) ^ 2)
                                + (parseInt(rekomendasi[j].shounen - parseInt(cluster[k].shounen)) ^ 2)
                                + (parseInt(rekomendasi[j].horor - parseInt(cluster[k].horor)) ^ 2)
                                + (parseInt(rekomendasi[j].martialarts - parseInt(cluster[k].martialarts)) ^ 2)
                                + (parseInt(rekomendasi[j].magic - parseInt(cluster[k].magic)) ^ 2)))
                                console.log(nilai)
                                anggota.push({
